...
export default function BetfairDashboard() {
  ...
  const criticalRecords = getRecordsByClassification('CRITICAL', market).slice(0, 5);
        ...
        <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6">
          ...
          <div className="mb-6">
            ...
            <p className="text-sm text-text-muted">
              {summary.total} monitored responses · {marketConfig.name} market
            </p>
          </div>
          ...
          <div className="mb-6">
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-sm font-medium text-text">Latest CRITICAL</h2>
              <a
                href="/betfair/list?classification=CRITICAL"
            ...
            <div className="space-y-3">
              ...
              {criticalRecords.length === 0 && (
                <p className="text-sm text-text-muted py-4 text-center">
                  No critical records found for this market
                </p>
              )}
            </div>
          </div>
